...
- [Menu] > [Workload Management] 메뉴로 이동합니다.
  ...
  {{< img src="../images/supervisor-cluster-check-1.png" width="600" >}}
...
- [Cluster] 탭을 클릭합니다.
  * Tanzu(Kubernetes)가 활성회된 vSphere Cluster를 볼 수 있습니다.
  ...
  {{< img src="../images/supervisor-cluster-check-2.png">}}
